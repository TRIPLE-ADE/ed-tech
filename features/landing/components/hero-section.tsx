...
import { Sparkles, ArrowRight, Play, BadgeInfo } from "lucide-react";
    ...
    <section className='relative min-h-[calc(100vh-64px)] flex items-center justify-center px-4 pt-8 pb-10'>
      ...
      <div className='container mx-auto text-center relative z-10'>
        ...
        <p className='text-xl text-gray-600 dark:text-gray-300 mb-10 max-w-3xl mx-auto leading-relaxed'>
          Unlock your full potential with ThryX AI. Our cutting-edge AI tools
          transform the way you study, learn, and retain information making
          learning faster, smarter, and more engaging than ever before.
        </p>
        ...
        <div className='flex flex-col sm:flex-row gap-6 justify-center mb-12'>
          ...
          <a href='#how-it-works' className='group'>
            {" "}
            {/* Updated to link to the new section */}
        ...
        <div className='grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto'>
          ...
          <StatCounter
            ...
            label='Our Vision: Active Learners'
            suffix='+'
          />
          <StatCounter
            end={1000000}
            label='Documents Processed (Goal)'
            suffix='+'
          />
